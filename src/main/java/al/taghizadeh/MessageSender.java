...
public class MessageSender {
    ...
    void send(String smsBoxUrl, String smsBoxPort, String receiver, String message, int priority, String dlrURL, String smscId) throws UnsupportedEncodingException{
...
//        param.append("&").append(URLEncoder.encode("smsc","UTF-8")).append("=").append(URLEncoder.encode(smscId,"UTF-8"));
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        sender.send(smsBoxUrl, smsBoxPort, "09146214039", messge, 0, sender.getDlrUrl("hello"), "polygator");
    }
}
